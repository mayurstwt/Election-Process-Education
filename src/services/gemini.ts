...
// Support both Vite env and runtime injection for Cloud Run
const API_KEY = (window as any).APP_CONFIG?.VITE_GEMINI_API_KEY || import.meta.env.VITE_GEMINI_API_KEY || "";
